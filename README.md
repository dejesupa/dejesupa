Hi 👋 My name is Trisha de Jesus
================================

Frontend Developer
------------------

I’m a Frontend Developer focused on creating clean, responsive, and user-friendly web experiences. I love turning design concepts into functional, visually engaging interfaces using HTML, CSS, JavaScript, React, and Tailwind CSS. My goal is to write clean, maintainable code that makes every interaction feel intuitive and enjoyable.

✨ I’m passionate about continuous learning and building projects that blend creativity with practical, thoughtful design.

🌍 Based in Virginia

✉️ Reach me at trisha.a.dejesus@gmail.com

💬 I enjoy building modern, responsive apps and transforming UI concepts into pixel-perfect, interactive experiences.
<p align="left">
...
**Tools & Workflow:**  
Git · VS Code · Node.js · Responsive Design · Component-Based Architecture

---

### 💬 About Me

- I love transforming UI concepts into **pixel-perfect, responsive experiences**
- Strong attention to detail and visual polish
- Always learning and improving through hands-on projects
- Enjoy collaborating and writing readable, scalable code
